                ...
                <form action="<?= BASE_URL ?>/torneos/editar/<?= (int)$torneo['idtorneo'] ?>" method="POST" class="torneo-form js-json-form">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="fechainicio" name="fechainicio" min="<?= $fechaMinima ?>" value="<?= htmlspecialchars($torneo['fechainicio']) ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="fechafin">Fecha de finalización</label>
                            <input type="date" id="fechafin" name="fechafin" min="<?= $fechaMinima ?>" value="<?= htmlspecialchars($torneo['fechafin']) ?>" required>
                        </div>
